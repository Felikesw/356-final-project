...
CREATE TABLE temp_risk_f (
    ...
    Journal LONGTEXT,
    Severe VARCHAR(24),
    `Severe lower bound` VARCHAR(24),
    `Severe upper bound` VARCHAR(24),
    `Severe p-value` VARCHAR(24),
    `Severe significant` VARCHAR(64), 
    `Severe adjusted` VARCHAR(64), 
    `Severe Calculated` VARCHAR(64), 

    Fatality VARCHAR(24),
    `Fatality lower bound` VARCHAR(24),
    `Fatality upper bound` VARCHAR(24),
    `Fatality p-value` VARCHAR(24),
